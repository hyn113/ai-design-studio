...
const translations = {
  ko: {
    ...
    lessonHarmonyMajorDesc: '근음·장3도·완전5도로 이루어진 가장 기본적인 3음 화음이에요. 장3도가 이 화음의 장조 성격을 결정해요.',
    lessonHarmonyMinorName: '단3화음',
    lessonHarmonyMinorDesc: '근음·단3도·완전5도로 이루어진 3음 화음이에요. 장3화음의 3도를 반음 낮춘 구조라 장조와 단조의 차이를 비교하기 좋아요.',
    lessonHarmonySuspendedName: '서스펜디드',
    lessonHarmonySuspendedDesc: '장조·단조를 결정하는 3도를 빼고 완전4도를 넣은 화음이에요. 4도가 3도로 내려가며 해결되는 진행에서 자주 사용돼요.',
    lessonHarmonyFifthName: '완전5도',
    lessonHarmonyFifthDesc: '근음과 완전5도 두 음만 쌓은 구조예요. 3도가 없어 장조·단조 성격이 정해지지 않는 중성적인 화음이에요.',
    lessonTensionHeading: '텐션',
    lessonTensionDesc: '텐션은 기본 화음에 한 음을 더해 분위기를 바꾸는 방법이에요.',
    lessonMajor7Name: '장7도 텐션',
    lessonMajor7Desc: '장3화음의 1·3·5도에 장7도를 더한 4음 화음이에요. 근음 바로 아래의 7도가 기본 장화음에 섬세한 긴장과 색채를 더해요.',
    lessonAdd9Name: '부가9도',
    lessonAdd9Desc: '장3화음의 1·3·5도에 한 옥타브 위의 2도인 9도를 더한 화음이에요. 7도 없이 9도만 더해 기본 화음의 성격을 유지하며 음역을 넓혀요.',
  ...
  en: {
    ...
    lessonHarmonyMajorDesc: 'A basic three-note chord built from the root, major third, and perfect fifth. The major third determines its major quality.',
    lessonHarmonyMinorName: 'Minor Triad',
    lessonHarmonyMinorDesc: 'A three-note chord built from the root, minor third, and perfect fifth. It differs from a major triad by lowering the third by one semitone.',
    lessonHarmonySuspendedName: 'Suspended',
    lessonHarmonySuspendedDesc: 'A chord that replaces the third with a perfect fourth. The fourth often resolves down to the third, creating a clear sense of suspension and release.',
    lessonHarmonyFifthName: 'Perfect Fifth',
    lessonHarmonyFifthDesc: 'A two-note structure made only from the root and perfect fifth. With no third, it does not define a major or minor quality.',
    lessonTensionHeading: 'Tension',
    lessonTensionDesc: 'Tension adds one note to a basic chord and changes its mood.',
    lessonMajor7Name: 'Major 7 Tension',
    lessonMajor7Desc: 'A four-note chord that adds a major seventh to a major triad (1–3–5–7). The seventh sits just below the octave and adds a close, colorful tension.',
    lessonAdd9Name: 'Add 9',
    lessonAdd9Desc: 'A major triad with the ninth—the second scale degree an octave higher—added to 1–3–5. It adds range and color without adding a seventh.',
...
function applyAICoachOperations() {
  ...
  aiCoachFeedback = {
    ...
    editSummary: currentLanguage === 'ko'
      ? `제안한 방향에 맞춰 ${operations.length}개의 블록을 수정했어요.`
      : `Applied ${operations.length} block edits based on the suggested direction.`
  };
  render();
  renderAICoachResult();
}

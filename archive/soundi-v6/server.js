  ...
  const response = await fetch('https://api.openai.com/v1/responses', {
    ...
    body: JSON.stringify({
      ...
      instructions: [
        ...
        'If payload.language is en, write every user-facing string in English only. If payload.language is ko, write every user-facing string in Korean only.',
        'Keep every sentence short and concrete.',
        'editSummary must explain the musical direction in words. Do not summarize as block counts.',
